  ...
  return (
    <main className={`memory-book ${finalClass}`} onPointerDown={onPointerDown} onPointerUp={onPointerUp} data-dragging={dragX !== null}>
      ...
      <section className={`book-page book-page-${current} book-page-${direction}`} aria-live="polite">
        {current === 'cover' && <div className="book-cover"><img className="book-illustration illustration-opening" src="/optimized/mood-book/central.jpg" alt="Central architectural line drawing" /><p className="book-kicker">01 / CITY AS A BOOK OF MEMORY</p><h1>A CITY IS NEVER<br />REMEMBERED<br /><em>ALL AT ONCE.</em></h1><p className="book-instruction">Turn the pages.</p><a className="book-skip-final" href="/mood?final=1">SKIP TO YOUR HONG KONG →</a></div>}
        {current === 'intro' && <div className="book-intro"><img className="book-illustration illustration-introduction" src="/optimized/mood-book/kennedy-town.jpg" alt="Kennedy Town coastal line drawing" /><p className="book-kicker">02 / INTRODUCTION</p><h2>FIVE PLACES.<br />FIVE MOMENTS.<br /><em>ONE CITY</em><br />YOU NOTICED DIFFERENTLY.</h2><div className="book-numbers">01&nbsp;&nbsp; 02&nbsp;&nbsp; 03&nbsp;&nbsp; 04&nbsp;&nbsp; 05</div></div>}
...
function FinalPostcardCanvas({ centralChoice, mongChoice, shamChoice, westChoice, kennedyChoice }: { centralChoice: string; mongChoice: string; shamChoice: string; westChoice: string; kennedyChoice: string }) {
  ...
  const kennedyImage = kennedyChoice === 'light' ? '/optimized/postcard/kennedy-town-light.jpg' : kennedyChoice === 'sea' ? '/optimized/postcard/kennedy-town-sea.jpg' : kennedyChoice === 'silence' ? '/optimized/postcard/kennedy-town-silence.jpg' : '/optimized/postcard/kennedy-town-feeling.jpg';
  ...
  return <div className={`book-final book-final-postcard result-${resultKey} postcard-central-${centralChoice} postcard-mong-${mongChoice} postcard-sham-${shamChoice} postcard-west-${westChoice} postcard-kennedy-${kennedyChoice}`}>
    ...
    <div className="final-map-field final-collage-field" aria-label="Personal Hong Kong collage">
      <div className="map-cluster cluster-sham"><div className="map-artwork">{shamChoice === 'objects' && <img {...imageProps} src="/optimized/postcard/sham-shui-po/objects.jpg" alt="" aria-hidden="true" />}{shamChoice === 'people' && <img {...imageProps} src="/optimized/postcard/sham-shui-po/people.jpg" alt="" aria-hidden="true" />}{shamChoice === 'imperfection' && <img {...imageProps} src="/optimized/postcard/sham-shui-po/imperfection.jpg" alt="" aria-hidden="true" />}{shamChoice === 'memory' && <img {...imageProps} src="/optimized/postcard/sham-shui-po/memory.jpg" alt="" aria-hidden="true" />}</div></div>
      <div className="map-cluster cluster-mong"><div className="map-artwork">{mongChoice === 'energy' && <img {...imageProps} src="/optimized/postcard/mong-kok/energy.jpg" alt="" aria-hidden="true" />}{mongChoice === 'people' && <img {...imageProps} src="/optimized/postcard/mong-kok/people.jpg" alt="" aria-hidden="true" />}{mongChoice === 'noise' && <img {...imageProps} src="/optimized/postcard/mong-kok/noise.jpg" alt="" aria-hidden="true" />}{mongChoice === 'details' && <img {...imageProps} src="/optimized/postcard/mong-kok/details.jpg" alt="" aria-hidden="true" />}</div></div>
      <div className="map-cluster cluster-west"><div className="map-artwork">{westChoice === 'form' && <img {...imageProps} src="/optimized/postcard/west-kowloon/form.jpg" alt="" aria-hidden="true" />}{westChoice === 'light' && <img {...imageProps} src="/optimized/postcard/west-kowloon/light.jpg" alt="" aria-hidden="true" />}{westChoice === 'distance' && <img {...imageProps} src="/optimized/postcard/west-kowloon/distance.jpg" alt="" aria-hidden="true" />}{westChoice === 'possibility' && <img {...imageProps} src="/optimized/postcard/west-kowloon/possibility.jpg" alt="" aria-hidden="true" />}</div></div>
      <div className="map-cluster cluster-central"><div className="map-artwork">{centralChoice === 'moving' && <img {...imageProps} src="/optimized/postcard/central/keep-moving.jpg" alt="" aria-hidden="true" />}{centralChoice === 'slow' && <img {...imageProps} src="/optimized/postcard/central/slow-down.jpg" alt="" aria-hidden="true" />}</div></div>
...
function CentralMemorySpread({ choice }: { choice: string }) {
  return <div className={`district-spread spread-central central-${choice}`}><img className="book-illustration illustration-central" src="/optimized/mood-book/opening.jpg" alt="Abstract open-book line drawing" /><p className="book-kicker">03 / CENTRAL · 01</p><div className="central-word">C<br />E<br />N<br />T<br />R<br />A<br />L</div><div className="central-lines" aria-hidden="true" /> <div className="central-data">08:42<br />47 FLOORS<br />22.2819 N<br />114.1582 E</div><p className="central-memory">Everything kept moving.<br /><em>You chose to {choice === 'moving' ? 'keep moving.' : 'slow down.'}</em></p><span className="spread-index">03 / MEMORY</span></div>;
}
